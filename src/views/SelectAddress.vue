	...
	<AppLayout>
		...
		<div class="min-h-screen bg-gray-100">
			<div class="flex p-6 gap-4">
				<!-- Left Side: Map -->
				<div class="w-2/3">
					<div class="h-[600px] rounded-lg shadow-lg overflow-hidden">
						<l-map
							ref="map"
							v-model:zoom="zoom"
							:center="mapCenter"
				...
				<div class="w-1/3 bg-white p-4 rounded-lg shadow-lg h-fit">
					...
					<div>
						<div class="relative">
							<input
								...
								placeholder="Cari alamat di Depok..."
						...
						<ul
							...
							class="mt-2 border rounded-lg shadow-sm"
						>
							<li
						...
						>
							...
							<input
								v-model="buyerName"
								class="w-full border px-2 py-1 rounded mb-3"
							/>
						...
						<button
							...
							class="w-full bg-blue-700 text-white py-2 rounded mt-4"
						>
							Gunakan Alamat Ini
						</button>
					</div>
	...
	setup() {
		...
		const validatePhoneNumber = () => {
			...
			if (!phoneNumber.value) {
				...
				phoneError.value = "Nomor telepon tidak valid (contoh: 08123456789)";
			} else {
				phoneError.value = "";
			}
		};
